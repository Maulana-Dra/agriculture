            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <form class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm text-green-600 hover:text-green-500 dark:text-green-400 dark:hover:text-green-300">
                            Forgot password?
                        </a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('register') }}" class="text-green-600 hover:text-green-500 dark:text-green-400 dark:hover:text-green-300 font-medium">
                            Sign up
                        </a>
                    </p>
                </div>
                ...
                if (response.success) {
                    ...
                    setTimeout(() => {
                        if (response.user.role === 'admin') {
                            ...
                            window.location.href = '{{ route("dashboard") }}'; // Customer dashboard
                        }
                    }, 1500);
                }
            } catch (error) {
