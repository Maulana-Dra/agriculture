...
<body class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
        ...
        <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Join ProjectAgri and start exploring</p>
                </div>
                ...
                <form class="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            name="name"
                            required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                    ...
                    <button
                        ...
                        class="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                    >
                        Create Account
                    </button>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('login') }}" class="text-green-600 hover:text-green-500 dark:text-green-400 dark:hover:text-green-300 font-medium">
                            Sign in
                        </a>
                    </p>
                </div>
    ...
    <script>
        ...
        let mockUsers = [
            {
                id: 1,
                email: 'customer@projectagri.com',
        ...
        // Form validation
        function validateRegisterForm(name, email, password, passwordConfirmation, terms) {
            const errors = [];
        ...
        function showError(message) {
            ...
            errorDiv.className = 'error-message bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6';
            errorDiv.innerHTML = `
                <div class="flex items-center">
                    <div class="flex-shrink-0">
        ...
        function showSuccess(message) {
            ...
            successDiv.className = 'success-message bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6';
            ...
            return new Promise((resolve, reject) => {
                setTimeout(() => {
                    ...
                    const newUser = {
                        ...
                        role: 'customer', // New registrations are customers by default
                        name: userData.name
                    };
        ...
        async function handleRegister(event) {
            ...
            // Validate form
            const errors = validateRegisterForm(name, email, password, passwordConfirmation, terms);
            if (errors.length > 0) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            passwordInput.addEventListener('input', function() {
                ...
                if (feedback.length > 0 && password.length > 0) {
                    strengthIndicator.innerHTML += `<br><small class="text-gray-500">Suggestions: ${feedback.join(', ')}</small>`;
                }
            });
